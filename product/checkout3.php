...
if (!$cart) {
    ...
    $insert_cart_query = "INSERT INTO cart (cart_id, member_id) VALUES (?, ?)";
    $insert_cart_stmt = $con->prepare($insert_cart_query);
    $insert_cart_stmt->bind_param("ii", $new_cart_id, $member_id);
